...
const pt: Dict = {
  ...
  'home.featured_title': 'Em destaque',
  'home.news_subtitle': 'Novidades sobre a academia, o grupo e outros temas relevantes',
  'footer.follow': 'Siga-nos nas nossas redes sociais',
  'footer.btt': 'Voltar ao topo',
